...
CREATE TABLE `user` (
  ...
  `image` varchar(50) DEFAULT 'none.jpg',
  PRIMARY KEY (`id`),
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EditProfile`(idKorisnik_ INT, username_ varchar(45), image_ varchar(50))
BEGIN
	UPDATE user
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `EditUser`(id_ INT, Username_ VARCHAR(50), Name_ VARCHAR(50), Surname_ VARCHAR(50), DateOfBirth_ DATE, IsAdmin_ INT)
BEGIN
   UPDATE user
