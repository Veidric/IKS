...
export class Register {
  ...
  addUser() {
    ...
    /*this.http.post('https://labos5-a8832-default-rtdb.europe-west1.firebasedatabase.app/users.json', this.new)
      .subscribe((res:any) => {
